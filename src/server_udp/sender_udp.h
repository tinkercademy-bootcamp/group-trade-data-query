...
void send_without_serialisation(int32_t sockfd, Result& result, const sockaddr_in& client_addr);
void send_without_serialisation(int32_t sockfd, TradeData& data, const sockaddr_in& client_addr);